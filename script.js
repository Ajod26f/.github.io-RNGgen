...
const translations = {
    ...
    ja: { subtitle: "いま激アツのRNGツール", settings: "生成設定", minimum: "最小値", maximum: "最大値", decimalMode: "小数を生成", precision: "小数桁数", amount: "個数", randomAmount: "個数をランダム化", amountMin: "最小個数", amountMax: "最大個数", unique: "重複なし", groupDuplicates: "重複をまとめる", sortMode: "並び順", generate: "数値を生成", results: "結果", saveBtn: "保存", loadBtn: "読み込み", advancedSettings: "高度な設定", highlightRules: "ハイライトルール", emptyError: "エラー: 空欄があります。", logicError: "エラー: 最小値が最大値を超えています。", capacityError: "エラー: 重複なしで生成可能な個数を超えています。", generated: "生成数", sum: "合計", average: "平均", min: "最小", max: "最大" }
};
